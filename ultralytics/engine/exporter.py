...
from ultralytics.nn.modules import C2f, Detect, RTDETRDecoder, PostDetectTRTNMS, PostDetectONNXNMS, DetectEfficient
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        # Input
        im = torch.zeros(self.args.batch, 3, *self.imgsz, device=self.device)
        file = Path(
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        ...
        # Import custom TensorRT plugins
        list_custom_trt_plugins = [
            [
                ROOT / "nn/extra_modules/ops_dcnv3/tensorrt/modulatedDeformConvV3Plugin/build/dcnv3_plugin.so",
                False,
            ],
        ]
