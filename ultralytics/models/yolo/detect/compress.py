...
from ultralytics.nn.modules import Detect, RepConv, v10Detect, PSA, SCDown, C2fCIB, C2f, SPPF
...
class DetectionCompressor(BaseTrainer):
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        try:
            if self.args.task == 'classify':
                ...
                self.data = check_det_dataset(self.args.data, rm_cache=self.args.rm_cache)
    ...
    def sparsity_learning(self, ckpt, world_size, prune):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            plt.close('all')
            LOGGER.info(f'epoch:{epoch} sparsity_ratio:{self.sparsity_ratio:.5f} bn_weight_1:{bn_weight_percent[0]:.10f} bn_weight_5:{bn_weight_percent[1]:.8f} bn_weight_10:{bn_weight_percent[2]:.8f}\nbn_weight_25:{bn_weight_percent[3]:.5f} bn_weight_50:{bn_weight_percent[4]:.5f} bn_weight_75:{bn_weight_percent[5]:.5f}')
