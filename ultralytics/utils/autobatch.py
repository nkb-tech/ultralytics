...
def check_train_batch_size(model, imgsz=640, amp=True, batch=-1, max_num_obj: int = 1):
    """
...
def autobatch(model, imgsz=640, fraction=0.60, batch_size=DEFAULT_CFG.batch, max_num_obj: int = 1):
    """
