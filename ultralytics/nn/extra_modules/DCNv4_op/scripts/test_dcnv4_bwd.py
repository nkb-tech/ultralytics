...
def check_forward_equal_with_pytorch_half():
    ...
    max_rel_err = ((output_flash_cuda - output_pytorch).abs() / (output_pytorch.abs() + 1e-3)).max()
    print(">>> forward half")
    print(
    ...
    exp_time_base = speed_test_backward(DCNv3Function.apply, test_args, fn_args, name="exp")
